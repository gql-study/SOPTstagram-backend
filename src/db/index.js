...
db.comment.belongsToMany(db.comment, { as: 'children', foreignKey: 'ParentCommentId', through: 'ParentComment' });
db.comment.belongsToMany(db.comment, { as: 'parent', foreignKey: 'commentId', through: 'ParentComment' })
